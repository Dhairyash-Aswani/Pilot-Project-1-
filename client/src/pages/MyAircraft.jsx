        ...
        <div className="overflow-x-auto bg-white shadow-md rounded-lg">
          <table className="min-w-full text-sm text-left text-gray-700">
            <thead className="text-xs text-white uppercase bg-[#FF4B2B]">
              <tr>
                <th scope="col" className="px-4 py-3">Tail Number</th>
                <th scope="col" className="px-4 py-3">MSN Number</th>
                <th scope="col" className="px-4 py-3">Model</th>
                <th scope="col" className="px-4 py-3">Maintenance Program / Revision</th>
                <th scope="col" className="px-4 py-3">Base</th>
                <th scope="col" className="px-4 py-3">Flight Hours</th>
                <th scope="col" className="px-4 py-3">Flight Cycles</th>
                <th scope="col" className="px-4 py-3">APU Hours</th>
                <th scope="col" className="px-4 py-3">APU Cycles</th>
                <th scope="col" className="px-4 py-3">Status</th>
                <th scope="col" className="px-4 py-3">System Serviceability</th>
